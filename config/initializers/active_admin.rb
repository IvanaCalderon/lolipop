ActiveAdmin.setup do |config|
  ...
  # Define the method to authenticate users for ActiveAdmin
  def authenticate_active_admin_user!
    authenticate_user! # Devise's built-in method to ensure the user is logged in

    # Ensure that the logged-in user is an HR user
